...
Config name
*/}}
{{- define "user-service.congigMapName" -}}
{{ include "user-service.fullname" . }}-config
{{- end }}
...
Service name
*/}}
{{- define "user-service.serviceName" -}}
...
Job name
*/}}
{{- define "user-service.initdb" -}}
{{ include "user-service.fullname" . }}-initdb
{{- end }}
